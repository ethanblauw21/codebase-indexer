...
- [ ] **Stage 3** — Prove on C++/C# fixtures via the ADR-008 harness (§4): resolution rate up, precision held. (Stages 1–2 ship the mechanism; the measured number is a follow-up.)
